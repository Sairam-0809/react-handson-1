    ...
    return (
        <>        
            ...
            <div className='back-button'>
                ...
                {contextData.filter((contextData)=> contextData.footer === "Hollywood Top").map((item ,index)=>{
                    // console.log(item);
                    console.log(item.id)
                    return (
                    <div className='bolly-top' key={index}>
                        <Link className='child' to={`/detailshollywood/${item.id}`}>                     
...
export default DynamicCompoHolly;